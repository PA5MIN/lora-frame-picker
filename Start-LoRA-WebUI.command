...
if ! "$LORA_VENV_PYTHON" -c 'import flask' >/dev/null 2>&1; then
  print "正在安装 WebUI 所需组件…"
...
"$LORA_VENV_PYTHON" lora_frame_picker_web.py
LORA_EXIT_CODE=$?
[[ $LORA_EXIT_CODE -eq 0 ]] || pause_on_error "WebUI 异常退出，错误码 $LORA_EXIT_CODE。"
